export declare class Arrayifier {
    ...
    /**
      ...
      * @returns Array
      */
    combination(arr: Array<any>, n: number, r: number, index: number, data: number[], i: number, results: number[][]): number[][];
    /**
      ...
      * @returns Array
      */
    getCombinations(arr: Array<any>, n: number, r: number): number[][];
}
